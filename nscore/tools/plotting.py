...
def compact_letter_display(
    ...
    """
    warnings.warn(
        "nscore.tools.plotting.compact_letter_display is deprecated. "
        "Use statistical_comparison_helpers.compact_letter_display instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def draw_samples_from_beta_posterior(
    ...
    """
    warnings.warn(
        "nscore.tools.plotting.draw_samples_from_beta_posterior is deprecated. "
        "Use statistical_comparison_helpers.draw_samples_from_beta_posterior instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def plot_model_comparison(
    ...
    """
    warnings.warn(
        "nscore.tools.plotting.plot_model_comparison is deprecated. "
        "Use statistical_comparison_helpers.plot_model_comparison instead.",
        DeprecationWarning,
        stacklevel=2,
    )
