...
if __name__ == "__main__":
    ...
    first_df_tmp = dict_of_dfs[df_keys[2]]
    ...
    n_resamples = 1
    RESULTS_PART_3 = np.zeros((n_tasks, 7, 2, n_resamples))
    for ii in range(n_tasks):
        ...
        for jj in range(n_resamples):
            ...
            if nsm_result.decision == Decision.AcceptAlternative:
                ...
                RESULTS_PART_3[ii, 0, 0, jj] = 1
                RESULTS_PART_3[ii, 0, 1, jj] = nsm_time_of_decision
            ...
            if nonparametric_nsm_result.decision == Decision.AcceptAlternative:
                ...
                RESULTS_PART_3[ii, 1, 0, jj] = 1
                RESULTS_PART_3[ii, 1, 1, jj] = nonparametric_nsm_time_of_decision
            ...
            if wsr_result.decision == Decision.AcceptAlternative:
                ...
                RESULTS_PART_3[ii, 2, 0, jj] = 1
                RESULTS_PART_3[ii, 2, 1, jj] = wsr_time_of_decision
            ...
            if binary_step_result.decision == Decision.AcceptAlternative:
                ...
                RESULTS_PART_3[ii, 3, 0, jj] = 1
                RESULTS_PART_3[ii, 3, 1, jj] = binary_step_time_of_decision
            ...
            if binary_nsm_result.decision == Decision.AcceptAlternative:
                ...
                RESULTS_PART_3[ii, 4, 0, jj] = 1
                RESULTS_PART_3[ii, 4, 1, jj] = binary_nsm_time_of_decision
            ...
            if binary_savi_result.decision == Decision.AcceptAlternative:
                ...
                RESULTS_PART_3[ii, 5, 0, jj] = 1
                RESULTS_PART_3[ii, 5, 1, jj] = binary_savi_time_of_decision
            ...
            if binary_wsr_result.decision == Decision.AcceptAlternative:
                ...
                RESULTS_PART_3[ii, 6, 0, jj] = 1
                RESULTS_PART_3[ii, 6, 1, jj] = binary_wsr_time_of_decision
    ...
    np.save("data/LBM/LBM_RESULTS_PART_3.npy", RESULTS_PART_3)