...
if __name__ == "__main__":
    ...
    TTD_BINARY_NSM = np.load(f"data/NSM/TTD_BINARY_NSM_alpha_{alpha}.npy")
    TTD_PC_NSM = np.load(f"data/NSM/TTD_PC_NSM_alpha_{alpha}.npy")
    TTD_CONT_NSM = np.load(f"data/NSM/TTD_CONT_NSM_alpha_{alpha}.npy")
    TTD_WSR = np.load(f"data/NSM/TTD_WSR_alpha_{alpha}.npy")
    TTD_SAVI = np.load(f"data/NSM/TTD_SAVI_alpha_{alpha}.npy")
    TTD_STEP = np.load(f"data/NSM/TTD_STEP_alpha_{alpha}.npy")

    POWER_BINARY_NSM = np.load(
        f"data/NSM/POWER_BINARY_NSM_alpha_{alpha}.npy"
    )
    POWER_PC_NSM = np.load(
        f"data/NSM/POWER_PC_NSM_alpha_{alpha}.npy"
    )
    POWER_CONT_NSM = np.load(
        f"data/NSM/POWER_CONT_NSM_alpha_{alpha}.npy"
    )
    POWER_WSR = np.load(
        f"data/NSM/POWER_WSR_alpha_{alpha}.npy"
    )
    POWER_SAVI = np.load(
        f"data/NSM/POWER_SAVI_alpha_{alpha}.npy"
    )
    POWER_STEP = np.load(
        f"data/NSM/POWER_STEP_alpha_{alpha}.npy"
    )
    ...
    fig_ttd_binary_nsm.savefig(f"data/NSM/TTD_BINARY_NSM.png", dpi=300)
    ...
    fig_ttd_pc_nsm.savefig(f"data/NSM/TTD_PC_NSM.png", dpi=300)
    ...
    fig_ttd_cont_nsm.savefig(f"data/NSM/TTD_CONT_NSM.png", dpi=300)
    ...
    fig_ttd_wsr.savefig(f"data/NSM/TTD_WSR.png", dpi=300)
    ...
    fig_ttd_savi.savefig(f"data/NSM/TTD_SAVI.png", dpi=300)
    ...
    fig_ttd_step.savefig(f"data/NSM/TTD_STEP.png", dpi=300)
    ...
    fig_ttd_diff.savefig(f"data/NSM/TTD_DIFF.png", dpi=300)
    ...
    fig_ttd_nonparametric_diff.savefig(f"data/NSM/TTD_NONPARAMETRIC_DIFF.png", dpi=300)
    ...
    fig_binary_NSM_terminal_power.savefig(f"data/NSM/POWER_BINARY_NSM.png", dpi=450)
    ...
    fig_pc_NSM_terminal_power.savefig(f"data/NSM/POWER_PC_NSM.png", dpi=450)
    ...
    fig_cont_NSM_terminal_power.savefig(f"data/NSM/POWER_CONT_NSM.png", dpi=450)
    ...
    fig_WSR_terminal_power.savefig(f"data/NSM/POWER_WSR.png", dpi=450)
    ...
    fig_SAVI_terminal_power.savefig(f"data/NSM/POWER_SAVI.png", dpi=450)
    ...
    fig_STEP_terminal_power.savefig(f"data/NSM/POWER_STEP.png", dpi=450)
    ...
    # fig_alt_cumulative_power.savefig("data/NSM/Alt_Cumulative_Power.png", dpi=300)
    ...
    # fig_null_cumulative_power.savefig("data/NSM/Null_Cumulative_Power.png", dpi=300)
