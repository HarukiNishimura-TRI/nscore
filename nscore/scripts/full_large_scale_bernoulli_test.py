...
from sequentialized_barnard_tests.nsm import PartialCreditNsmTest
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Bernoulli NSM
        np.save(
            f"data/NSM/Cumulative_Power_Binary_NSM_null_alpha_{alpha}.npy",
            CUMULATIVE_POWER_BINARY_NSM[0, :null_counter, :],
        )
        np.save(
            f"data/NSM/Cumulative_Power_Binary_NSM_alt_alpha_{alpha}.npy",
            CUMULATIVE_POWER_BINARY_NSM[1, :alt_counter, :],
        )
        # Partial Credit NSM
        np.save(
            f"data/NSM/Cumulative_Power_PC_NSM_null_alpha_{alpha}.npy",
            CUMULATIVE_POWER_PC_NSM[0, :null_counter, :],
        )
        np.save(
            f"data/NSM/Cumulative_Power_PC_NSM_alt_alpha_{alpha}.npy",
            CUMULATIVE_POWER_PC_NSM[1, :alt_counter, :],
        )
        # Nonparametric NSM
        np.save(
            f"data/NSM/Cumulative_Power_Cont_NSM_null_alpha_{alpha}.npy",
            CUMULATIVE_POWER_CONT_NSM[0, :null_counter, :],
        )
        np.save(
            f"data/NSM/Cumulative_Power_Cont_NSM_alt_alpha_{alpha}.npy",
            CUMULATIVE_POWER_CONT_NSM[1, :alt_counter, :],
        )
        # WSR
        np.save(
            f"data/NSM/Cumulative_Power_WSR_null_alpha_{alpha}.npy",
            CUMULATIVE_POWER_WSR[0, :null_counter, :],
        )
        np.save(
            f"data/NSM/Cumulative_Power_WSR_alt_alpha_{alpha}.npy",
        ...
        # STEP
        np.save(
            f"data/NSM/Cumulative_Power_STEP_null_alpha_{alpha}.npy",
            CUMULATIVE_POWER_STEP[0, :null_counter, :],
        )
        np.save(
            f"data/NSM/Cumulative_Power_STEP_alt_alpha_{alpha}.npy",
